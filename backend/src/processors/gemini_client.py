...
class GeminiClient:
    ...
    async def generate_post_content(self, listing_data: dict) -> str:
        prompt = f"""
Напиши ОДИН короткий, интригующий и продающий пост для Telegram-канала о продаже квартиры. НЕ ДОБАВЛЯЙ никаких вводных фраз типа "Конечно, вот несколько вариантов" или "Вариант 1". Сразу выдай готовый текст поста.
